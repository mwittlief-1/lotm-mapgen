...
import { addCourtExtraId, courtConsumptionBushels_v0_2_4, ensureCourtOfficers, getCourtOfficerIds } from "./court.js";
        ...
        if (effectiveAct === "accept") {
            ...
            if (prospect.type === "marriage" && prospect.subject_person_id) {
                ...
                if (spouseJoinsCourt && typeof spouseId === "string" && spouseId.length > 0 && spouseId !== sid) {
                    ...
                    if (idx2 >= 0)
                        state.house.children.splice(idx2, 1);
                }
            }
            prospectsLog.push({
...
function applyMarriageDecision(state, ctx, decisions, reportNotes) {
    ...
    if (d.action === "accept") {
        ...
        if (spouseJoinsCourt) {
            ...
            if (idx >= 0)
                state.house.children.splice(idx, 1);
        }
